...
function SideNav() {
  return (
    <nav className="mt-5 px-2 text-center">
      ...
      <a
        href="#"
        className="  flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-blue-800 hover:text-blue-300"
      >
      ...
      <a
        href="#"
        className="  flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300"
      >
